 ...
 */const R=function(e){let t=C(e);return N.encodeByteArray(t,!0)},x=function(e){// Use base64url encoding and remove padding in the end (dot characters).
 ...
 */const J=[];(eq=eK||(eK={}))[eq.DEBUG=0]="DEBUG",eq[eq.VERBOSE=1]="VERBOSE",eq[eq.INFO=2]="INFO",eq[eq.WARN=3]="WARN",eq[eq.ERROR=4]="ERROR",eq[eq.SILENT=5]="SILENT";const Z={debug:eK.DEBUG,verbose:eK.VERBOSE,info:eK.INFO,warn:eK.WARN,error:eK.ERROR,silent:eK.SILENT},ee=eK.INFO,et={[eK.DEBUG]:"log",[eK.VERBOSE]:"log",[eK.INFO]:"info",[eK.WARN]:"warn",[eK.ERROR]:"error"},en=(e,t,...n)=>{if(t<e.logLevel)return;let r=new Date().toISOString(),i=et[t];if(i)console[i](`[${r}]  ${e.name}:`,...n);else throw Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class er{/**
...
setLogLevel(e){this._logLevel="string"==typeof e?Z[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}/**
     ...
     */debug(...e){this._userLogHandler&&this._userLogHandler(this,eK.DEBUG,...e),this._logHandler(this,eK.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,eK.VERBOSE,...e),this._logHandler(this,eK.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,eK.INFO,...e),this._logHandler(this,eK.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,eK.WARN,...e),this._logHandler(this,eK.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,eK.ERROR,...e),this._logHandler(this,eK.ERROR,...e)}}const ei=(e,t)=>t.some(t=>e instanceof t),es=new WeakMap,ea=new WeakMap,eo=new WeakMap,el=new WeakMap,eh=new WeakMap;let eu={get(e,t,n){if(e instanceof IDBTransaction){// Special handling for transaction.done.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ig=new er("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ib={// Causes are copied from:
...
t.push(...n.split("/").filter(e=>e.length>0))}return new iU(t)}static emptyPath(){return new iU([])}}const iB=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 ...
 */function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new i5(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return iM(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}i5.EMPTY_BYTE_STRING=new i5("");const i3=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s5=new iZ(ij.comparator),s3=new iZ(ij.comparator);function s7(...e){let t=s3;for(let n of e)t=t.insert(n.key,n);return t}function s8(e){let t=s3;return e.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function ae(){return new s6(e=>e.toString(),(e,t)=>e.isEqual(t))}const at=new iZ(ij.comparator),an=new i2(ij.comparator);function ar(...e){let t=an;for(let n of e)t=t.add(n);return t}const ai=new i2(iM);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aV=new iu([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
...
r.Be(t),this.Ue=this.Ue.insert(t,this.ct(t).delete(e)),n&&(this.$e=this.$e.insert(t,n))}removeTarget(e){this.Ke.delete(e)}/**
     ...
     * specified target.
     */ut(e,t){return this.Qe.getRemoteKeysForTarget(e).has(t)}}function aW(){return new iZ(ij.comparator)}function aY(){return new iZ(ij.comparator)}const aX={asc:"ASCENDING",desc:"DESCENDING"},aJ={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},aZ={and:"AND",or:"OR"};/**
 ...
 */!function(e,t=!0){ip="10.3.0",eS(new Q("firestore",(e,{instanceIdentifier:n,options:r})=>{let i=e.getProvider("app").getImmediate(),s=new hu(new iD(e.getProvider("auth-internal")),new ix(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new iT(ib.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ss(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),eN(ic,"4.1.2",void 0),eN(ic,"4.1.2","esm2017")}();const h1={apiKey:"AIzaSyB0CDf8n0_dnI0OVtFXls1AhBHb1xZCNBA",authDomain:"movies-fe012.firebaseapp.com",projectId:"movies-fe012",storageBucket:"movies-fe012.appspot.com",messagingSenderId:"223207472721",appId:"1:223207472721:web:c09d3fe8e90acbe85b4270"},h2="movies",h9="changed",h4="hidden",h6=document.getElementById("add__app-form"),h5=document.getElementById("add__app-input"),h3=document.getElementById("add__app-list");let h7=[];// функции----------------------------------------------
...
const ue=e=>e.target.closest(".add__app-film");// рендер каждого нового фильма
